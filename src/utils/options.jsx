...
const propasalLeadOptions = [
    { value: 'web', label: 'Korhan Afsar - Website design and development', img: "/images/avatar/1.png" },
    { value: 'ui', label: 'Curtis Green - User experience (UX) and user interface (UI) design', img: "/images/avatar/1.png" },
    { value: 'mobile', label: 'Korhan Afsar - Responsive and mobile design', img: "/images/avatar/1.png" },
    { value: 'ecommerce', label: 'Korhan Afsar - E-commerce website design and development', img: "/images/avatar/1.png" },
...
const taskAssigneeOptions = [
    {
        ...
        label: "korhanafsar@gmail.com",
        value: "korhanafsar@gmail.com",
    },
