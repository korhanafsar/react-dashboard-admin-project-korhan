        ...
        <div className="card stretch stretch-full">
            <div className="card-body">
                <div className="mb-4 text-center">
                    ...
                    <div className="mb-4">
                        <a href="#" className="fs-14 fw-bold d-block"> Korhan Afsar</a>
                        <a href="#" className="fs-12 fw-normal text-muted d-block">korhanafsar@gmail.com</a>
                    </div>
                ...
                <ul className="list-unstyled mb-4">
                    ...
                    <li className="hstack justify-content-between mb-0">
                        ...
                        <a href="#" className="float-end">korhanafsar@gmail.com</a>
                    </li>
                </ul>
