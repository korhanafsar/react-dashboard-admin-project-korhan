                    ...
                    <div className="card stretch stretch-full">
                        <div className="card-body task-header d-lg-flex align-items-center justify-content-between">
                            <div className="mb-4 mb-lg-0">
                                <h4 className="mb-3 fw-bold text-truncate-1-line">KorhanAfsar || CRM Applications & Admin Dashboar</h4>
                    ...
                    <div className="card stretch stretch-full">
                        <div className="card-body task-info">
                            <div className="mb-4">
                                ...
                                <span className="fs-12 fw-normal text-muted d-block">Created at 2025-02-12 08:47:47</span>
                            </div>
                            <div className="task-info-list">
                                ...
                                <div className="row align-items-center mb-3 task-list-row">
                                    ...
                                    <div className="col-6 d-flex">
                                        <span className="border-bottom border-bottom-dashed border-gray-5">26 May, 2025</span>
                                        <div className="ms-2">
                                ...
                                <div className="row align-items-center mb-3 task-list-row">
                                    ...
                                    <div className="col-6 d-flex">
                                        <span className="border-bottom border-bottom-dashed border-gray-5">30 May, 2025</span>
                                        <div className="ms-2">
                                            <a href="#" className="avatar-text avatar-sm">
                                                <FiEdit3 />
                                            </a>
