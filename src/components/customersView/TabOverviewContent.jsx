...
const informationData = [
    { label: 'Full Name', value: 'Korhan Afsar' },
    ...
    { label: 'Email Address', value: 'korhanafsar@gmail.com' },
    { label: 'Location', value: 'California, Turkey' },
    { label: 'Joining Date', value: '20 Dec, 2025' },
    { label: 'Country', value: 'Turkey' },
    { label: 'Communication', value: 'Email, Phone' },
    { label: 'Allow Changes', value: 'YES' },
    { label: 'Website', value: 'https://korhanafsar.net/user/theme_ocean' },
];
            ...
            >
                ...
                <div>
                    ...
                    <p className="fs-10 fw-medium text-uppercase text-truncate-1-line">
                        Last Update: <strong>26 Dec, 2025</strong>
                    </p>
                    <a
                        href="#"
