                ...
                <div className="card-body p-0">
                    <div className="px-4 pt-4">
                        <div className="d-sm-flex align-items-center justify-content-between">
                            <div>
                                <div className="fs-24 fw-bolder font-montserrat-alt text-uppercase">KorhanAfsar</div>
                            ...
                            <div className="lh-lg pt-3 pt-sm-0">
                                ...
                                <div>
                                    ...
                                    <span className="text-muted">28 Feb, 2025</span>
                                </div>
                                <div>
                                    <span className="fw-bold text-dark">Issued Date: </span>
                                    <span className="text-muted">25 JAN, 2025</span>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div className="mt-4 mt-sm-0">
                                ...
                                <div className="text-muted lh-lg">
                                    ...
                                    <div>
                                        ...
                                        <span className="fw-bold text-dark"> Korhan Afsar</span>
                                    </div>
                                    <div>
                    ...
                    <div className="table-responsive">
                        <table className="table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td colSpan="3"></td>
                                    <td className="fw-semibold text-dark bg-gray-100 text-lg-end">Discount (NXL2025 - 15%)</td>
                    ...
                    <div className="px-4 pt-4 d-sm-flex align-items-center justify-content-between">
                        ...
                        <div className="text-center">
                            ...
                            <p className="fs-11 fw-semibold text-muted">26 MAY 2025, 10:35PM</p>
                        </div>
                    </div>
                </div>
            </div>
