                        ...
                        <div className="px-4 row justify-content-between">
                            <div className="col-xl-3">
                                <div className="form-group mb-3">
                                    ...
                                    <input type="text" className="form-control" id="InvoiceLabel" placeholder="KorhanAfsar Invoice" />
                                </div>
                            </div>
                            <div className="col-xl-3">
                                <div className="form-group mb-3">
                                    <label htmlFor="InvoiceNumber" className="form-label">Invoice Number</label>
                                    <input type="text" className="form-control" id="InvoiceNumber" placeholder="#NXL2025" />
                                </div>
                            </div>
