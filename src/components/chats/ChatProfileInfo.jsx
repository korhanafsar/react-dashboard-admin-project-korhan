        ...
        <div className="offcanvas offcanvas-end userProfileDetails" id="userProfileDetails" aria-hidden="true" tabIndex={-1}>
            ...
            <div className="offcanvas-body p-0">
                <div className="p-4 text-center position-relative">
                    ...
                    <h2 className="text-dark fs-13 fw-bold mt-3 mb-0">Korhan Afsar
                    ...
                    <span className="fs-12 text-muted d-block mb-3">korhanafsar@gmail.com</span>
                ...
                <div className="p-4 fs-13 collapse show" id="PersonalInfo">
                    ...
                    <div className="d-flex align-items-start mb-3">
                        ...
                        <a href="#">korhanafsar@gmail.com</a>
                    </div>
                    <div className="d-flex align-items-start mb-3">
                        <div className="me-3">
                    ...
                    <div className="d-flex align-items-start mb-3">
                        ...
                        <div><span className="fw-medium text-muted">Recent activity by </span> <a href="#" className="ac-info-sidebar-open-trigger">Korhan Afsar</a></div>
                    </div>
